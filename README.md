### Важно!
1. На данный момент эта инструкция не актуальна. Сейчас Я работаю над hазделением этого проекта на микросервисы. Надеюсь в ближайшее время Я выложу обновленный сервис.
2. MPstats больше не работает для сборки ключей. Было принято решение перейти на сервис wildbox для сборки ключей и данных о товаре.
